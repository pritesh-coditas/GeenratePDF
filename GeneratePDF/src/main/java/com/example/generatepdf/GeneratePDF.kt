...
object GeneratePdf {
    ...
    fun build(context: Context, userName:String,
        ...
        canvas.drawText(schoolName, 40F, 90F, myPaint)
        canvas.drawText(schoolMarks, 40F, 100F, myPaint)
        canvas.drawText(collegeName, 40F, 110F, myPaint)
        canvas.drawText(collegeMarks, 40F, 120F, myPaint)
        canvas.drawText(diplomaCollegeName, 40F, 130F, myPaint)
        canvas.drawText(diplomaCollegeMarks, 40F, 140F, myPaint)
        canvas.drawText(degreeCollegeName, 40F, 150F, myPaint)
        canvas.drawText(degreeMarks, 40F, 160F, myPaint)
        canvas.drawText(programmingLanguage, 170F, 80F, myPaint)
        canvas.drawText(softwareTools, 40F, 180F, myPaint)
        canvas.drawText(certification, 40F, 190F, myPaint)
        canvas.drawText(otherSkills, 40F, 200F, myPaint)
